...
viewer1 = ImageViewer(root, 'Estimador de precipitación', 'G:/Otros ordenadores/PC GERMAIN/RRQPE_emision/', 0)
viewer2 = ImageViewer(root, 'Agua precipitable total', 'G:/Otros ordenadores/PC GERMAIN/TPW_emision/', 1)
viewer3 = ImageViewer(root, 'Altura de la parte superior de las nubes', 'G:/Otros ordenadores/PC GERMAIN/ACHA_emision/', 2)
viewer4 = ImageViewer(root, 'Fase de la cima de la nube', 'G:/Otros ordenadores/PC GERMAIN/ACTP_emision/', 3)
...
root.after(530000, close_after_60_seconds)  # Cierra la ventana después de 3600 segundos
