...
def deteccion_cloud(destino , ruta_clouds_mask, ruta_departamentos_mask, save_path, treshold):
    #cloud_mask, imagen_rgb, name_img= generator_cloud_mask(destino, ruta_clouds_mask)
    generator_cloud_mask(destino, ruta_clouds_mask)

    
    
def deteccion_precipitation(destino , ruta_clouds_mask, ruta_departamentos_mask, save_path, treshold):
    #cloud_mask, imagen_rgb, name_img= generator_precipitation_mask(destino, ruta_clouds_mask)
    generator_precipitation_mask(destino, ruta_clouds_mask)
